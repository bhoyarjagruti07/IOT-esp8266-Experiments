/*
 * Sketch : MQTT protocol with ESP8266 Witty Cloud Development Board and Adafruit IO
 * Notes  : For adding the ESP8266 board in the Arduino IDE follow the following steps
 *          1) Go to File > Preferences. In Additional Boards Manager URLs copy-paste the following link 
 *             http://arduino.esp8266.com/stable/package_esp8266com_index.json. Then hit OK.
 *          2) Go to Tools > Board > Board Manager. Search esp8266. Install it.
 *          3) Go to Tools > Board > ESP8266 Boards (3.0.2) > NodeMCU 1.0 (ESP-12E Module)        
...
#define WLAN_SSID       "JagrutiBhoyar"
#define WLAN_PASS       "Jagruti@123"

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                // mqtt: 1883, secure-mqtt: 8883
#define AIO_USERNAME    "Jagruti_07"
#define AIO_KEY         "aio_PwNK89dooKtTRpb71DxkO3gWDG8Q"
...
Adafruit_MQTT_Publish lightintensity = Adafruit_MQTT_Publish( &mqtt, AIO_USERNAME "/feeds/LDR");   // declare publisher
Adafruit_MQTT_Subscribe redbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/Blue LED");      // declare subscriber
Adafruit_MQTT_Subscribe greenbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/Green LED");  // declare subscriber
Adafruit_MQTT_Subscribe bluebutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/Red LED");    // declare subscriber
